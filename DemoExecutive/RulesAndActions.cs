///////////////////////////////////////////////////////////////////////
// RulesAndActions.cs - DepAnal rules specific to an application     //
// ver 2.3                                                           //
 ...
 *
 * It defines the following six rules which each have a
 ...
 *   Semi.cs, Toker.cs, TypeAnal.cs, DepAnal.cs
 *   
 * Build command:
...
namespace CodeAnalysis
{
    ...
    class DetectStruct : ARule
    {
        public override bool test(ITokenCollection semi)
        {          
            Display.displayRules(actionDelegate, "rule DetectStruct");
            int index;
    ...
    class BuildCodeAnalyzer_relation
    {
        Repository repo = new Repository();
